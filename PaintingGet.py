# filter: Medium(Painting),Artist Nationality(Chinese),Time Period(2020s,2010s,2000s,1990s,1980s)
# url: https://www.artsy.net/collect?major_periods%5B0%5D=2020&major_periods%5B1%5D=2010&major_periods%5B2%5D=2000&major_periods%5B3%5D=1990&major_periods%5B4%5D=1980&additional_gene_ids%5B0%5D=painting&artist_nationalities%5B0%5D=Chinese&acquireable=false&offerable=false&at_auction=false&inquireable_only=false
...
for page in range (1, 101):
    ...
    for a in aLabels:
        ...
        with open('PaintingGet.csv', mode='a', encoding='utf_8_sig', newline='') as f:
